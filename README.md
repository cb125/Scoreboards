...
* ***Omicron update*** 19 December.  *We continue to look forward to having in-person interactions during the seminar sessions.  However, given the current state of the pandemic, we recognize that some people, for a variety of reasons, will have to participate via zoom.  We expect that people who are local for the relevant session will participate in person as much as they reasonably can.  We'll continue to adjust as events unfold.*
